...
//         child: BottomNavBar(), // เพิ่ม BottomNavBar ที่นี่
//       ),
//       body: Padding(
...
//               // แสดงวันที่ที่เลือกใน TextField เดียวกัน
//               // TextField(
//               //   controller: _dateController,
//               //   enabled: true, // ทำให้สามารถแก้ไขได้ (ให้แสดงวันที่ที่เลือก)
//               //   decoration: InputDecoration(
//               //     hintText: "วันที่หมดอายุ",
//               //     hintStyle: TextStyle(
//               //       color: Colors.black,
//               //     ), // เพิ่มสีให้กับข้อความ hint
//               //     labelText:
//               //         "แสดงวันที่หมดอายุ", // เพิ่ม label ข้อความที่อธิบาย
//               //     labelStyle: TextStyle(color: Colors.black), // สีของ label
//               //     border: OutlineInputBorder(
//               //       borderSide: BorderSide(color: Colors.black), // กรอบขอบดำ
//               //       borderRadius: BorderRadius.circular(16),
//               //     ),
//               //     focusedBorder: OutlineInputBorder(
//               //       borderSide: BorderSide(
//               //         color: Colors.blue,
//               //       ), // กรอบเมื่อเลือก TextField
//               //       borderRadius: BorderRadius.circular(16),
//               //     ),
